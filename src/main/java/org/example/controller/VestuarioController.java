...
import org.example.controller.request.VestuarioRequest;
...
public class VestuarioController {
    ...
    public String cadastrarProduto(@RequestBody VestuarioRequest requestVestuario) throws NomeJaCadastrado, SQLException, ProdutoJaCadastradoException {
    ...
    public String deleterProdutoVestuario(@PathVariable String codigo) throws SQLException {
        estoqueService.apagarProdutoPorCodigo(codigo);
