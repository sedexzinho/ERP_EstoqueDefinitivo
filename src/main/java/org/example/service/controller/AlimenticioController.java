...
public class AlimenticioController {
    Alimenticio alimenticioService = new Alimenticio();

    @PostMapping("/cadastro")
    public String cadastrarProduto(@RequestBody Alimenticio alimenticioRequest) throws NomeJaCadastrado, SQLException, ProdutoJaCadastradoException {
